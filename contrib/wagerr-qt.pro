...
RESOURCES += src/qt/wagerr.qrc src/qt/wagerr_locale.qrc

TRANSLATIONS += src/qt/locale/wagerr_bg.ts \
                src/qt/locale/wagerr_de.ts \
                src/qt/locale/wagerr_en.ts \
                src/qt/locale/wagerr_es.ts \
                src/qt/locale/wagerr_fi.ts \
                src/qt/locale/wagerr_fr.ts \
                src/qt/locale/wagerr_it.ts \
                src/qt/locale/wagerr_ja.ts \
                src/qt/locale/wagerr_pl.ts \
                src/qt/locale/wagerr_pt.ts \
                src/qt/locale/wagerr_ru.ts \
                src/qt/locale/wagerr_sk.ts \
                src/qt/locale/wagerr_sv.ts \
                src/qt/locale/wagerr_vi.ts \
                src/qt/locale/wagerr_zh_CN.ts \
                src/qt/locale/wagerr_zh_TW.ts
