...
*Setup instructions for a gitian build of Wagerr using a Debian VM or physical system.*
...
- [Building Wagerr](#building-wagerr)
...
Clone the git repositories for wagerr and gitian and then checkout the wagerr version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/wagerr-crypto/wagerr.git
cd wagerr
...
Follow the instructions in [doc/release-process.md](release-process.md) in the wagerr repository
...
To build Wagerr (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the wagerr repository.
...
```bash
    ...
    From https://github.com/wagerr-crypto/wagerr
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/wagerr-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/wagerr-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/wagerr-build.assert
```
...
[wagerr/gitian.sigs](https://github.com/wagerr-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
