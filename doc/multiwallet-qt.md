...
In order to support loading of multiple wallets in wagerr-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is wagerr.cpp.
...
Changes to wagerr.cpp
----------------------
wagerr.cpp is the entry point into wagerr-qt, and as such, will require some minor modifications to provide hooks for
