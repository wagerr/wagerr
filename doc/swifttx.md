...
This mechanism has been integrated into Bitcore-Node-WAGERR which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/WAGERR-Project/insight-api-wagerr#web-socket-api](https://github.com/WAGERR-Project/insight-api-wagerr#web-socket-api) 
* API: [https://github.com/WAGERR-Project/insight-api-wagerr#swifttx-transactions](https://github.com/WAGERR-Project/insight-api-wagerr#swifttx-transactions) 
...
By default, the WAGERR Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the WAGERR Core daemon:
