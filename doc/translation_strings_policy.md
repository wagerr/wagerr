...
This document provides guidelines for internationalization of the WAGERR Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wagerr_en.ts` remains unchanged.
