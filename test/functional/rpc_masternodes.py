...
class MasterNodeTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].getnewaddress('node0')
        ...
        self.stop_node(0)
        self.start_node(0)
        self.log.info("Confirming Zerocoin Transactions")
        ...
        #exit(1)
        nextsblock=self.nodes[0].getnextsuperblock()
        prophash=self.nodes[0].preparebudget("test1", "https://forum.wagerr.com/t/test-proposal", 10, nextsblock, mnaddr0, 100)
        self.log.info("Prepared Budget %s" % prophash)
        self.log.info("Generating 3 blocks to confirm")
        self.nodes[0].generate(3)
        self.log.info("Block Count Node 0 %s" % self.nodes[0].getblockcount())
        subhash=self.nodes[0].submitbudget("test1", "https://forum.wagerr.com/t/test-proposal", 10, nextsblock, mnaddr0, 100, prophash)
        ...
        #self.log.info("Get Events Liability %s" % self.nodes[0].geteventsliability()) # TODO need oracle node
        #self.log.info("Get Mapping ID %s" % self.nodes[0].getmappingid()) # TODO Need Oracle Node
        #self.log.info("Get Mapping Name %s" % self.nodes[0].getmappingname()) # TODO Need Oracle Node
        ...
        #self.log.info("Get Pool Info %s" % self.nodes[0].getpoolinfo()) # TODO Need Oracle Node
        self.log.info("List Chaingame Bets %s" % self.nodes[0].listchaingamesbets())
        self.log.info("List Chaingame Events %s" % self.nodes[0].listchaingamesevents())
        #self.log.info("List Events %s" % self.nodes[0].listevents()) # TODO Need Oracle Node
