...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Wagerr Core wagerr-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  wagerr-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wagerr transaction") + "\n" +
                               "  wagerr-tx [options] -create [commands]   " + _("Create hex-encoded wagerr transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded wagerr transaction
