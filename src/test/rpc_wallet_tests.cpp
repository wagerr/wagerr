...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    /* WczRtSV2Hokm1CM48MhW9Tt5rEBXGiD9fU is not owned by the test wallet. */
    BOOST_CHECK_THROW(CallRPC("setaccount WczRtSV2Hokm1CM48MhW9Tt5rEBXGiD9fU nullaccount"), std::runtime_error);
    BOOST_CHECK_THROW(CallRPC("setaccount"), std::runtime_error);
    /* WczRtSV2Hokm1CM48MhW9Tt5rEBXGiD9f (33 chars) is an illegal address (should be 34 chars) */
    BOOST_CHECK_THROW(CallRPC("setaccount WczRtSV2Hokm1CM48MhW9Tt5rEBXGiD9f nullaccount"), std::runtime_error);
    ...
    BOOST_CHECK_THROW(CallRPC("signmessage WczRtSV2Hokm1CM48MhW9Tt5rEBXGiD9fU mymessage"), std::runtime_error);
    ...
    /* Illegal address */
    BOOST_CHECK_THROW(CallRPC("verifymessage WczRtSV2Hokm1CM48MhW9Tt5rEBXGiD9f " + retValue.get_str() + " mymessage"), std::runtime_error);
    /* wrong address */
    BOOST_CHECK(CallRPC("verifymessage WczRtSV2Hokm1CM48MhW9Tt5rEBXGiD9fU " + retValue.get_str() + " mymessage").get_bool() == false);
