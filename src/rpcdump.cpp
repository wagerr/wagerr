...
UniValue importprivkey(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "importprivkey \"wagerrprivkey\" ( \"label\" rescan )\n"
            "\nAdds a private key (as returned by dumpprivkey) to your wallet.\n" +
            HelpRequiringPassphrase() + "\n"

            "\nArguments:\n"
            "1. \"wagerrprivkey\"   (string, required) The private key (see dumpprivkey)\n"
...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"wagerraddress\"\n"
            "\nReveals the private key corresponding to 'wagerraddress'.\n"
            "Then the importprivkey can be used with this output\n" +
            HelpRequiringPassphrase() + "\n"

            "\nArguments:\n"
            "1. \"wagerraddress\"   (string, required) The wagerr address for the private key\n"
...
UniValue dumpwallet(const UniValue& params, bool fHelp)
{
    ...
    // produce output
    file << strprintf("# Wallet dump created by Wagerr %s (%s)\n", CLIENT_BUILD, CLIENT_DATE);
...
UniValue bip38encrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"wagerraddress\" \"passphrase\"\n"
            "\nEncrypts a private key corresponding to 'wagerraddress'.\n" +
            HelpRequiringPassphrase() + "\n"

            "\nArguments:\n"
            "1. \"wagerraddress\"   (string, required) The wagerr address for the private key (you must hold the key already)\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("bip38encrypt", "\"Wf1QqABAiQ17aorbB2WTcWAr6HF6zQRLmV\" \"mypasphrase\"") +
            HelpExampleRpc("bip38encrypt", "\"Wf1QqABAiQ17aorbB2WTcWAr6HF6zQRLmV\" \"mypasphrase\""));
...
UniValue bip38decrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38decrypt \"wagerraddress\" \"passphrase\"\n"
