...
void PlaceBetDialog::prepareBet(CEvent* event, const std::string& teamToWin, const std::string& oddsToWin)
{
    ...
    countryNames.insert(make_pair("CHE", "Switzerland"));
