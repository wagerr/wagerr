                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Wagerr Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Wagerr address"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zWGR"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Wagerr Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Wagerr"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Wagerr Core help message to get a list with possible Wagerr command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Wagerr Core client") + " " + networkStyle->getTitleAddText();
